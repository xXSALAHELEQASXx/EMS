...
//
// Represents the Firebase app configuration.
__turbopack_context__.s({
...
const firebaseConfig = {
    ...
    measurementId: "G-MOCKMEASUREMENTID"
};
...
function initializeFirebase() {
    ...
    const app = apps.length > 0 ? apps[0] : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["initializeApp"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
...
function FirebaseProvider({ children }) {
    _s();
    const { app, auth, firestore } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useFirebase"])();
...
_s(FirebaseProvider, "qYXZ1DC4uky2kwBc/hGqSwxps4c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useFirebase"]
    ];
});
_c = FirebaseProvider;
...
_s1(useFirebaseContext, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
function useFirebaseApp() {
    _s2();
    return useFirebaseContext().app;
}
_s2(useFirebaseApp, "Ji0v3CVyR05GsJImBIA8jBWheXQ=", false, function() {
    return [
        useFirebaseContext
    ];
});
...
_s3(useAuth, "Ji0v3CVyR05GsJImBIA8jBWheXQ=", false, function() {
    return [
        useFirebaseContext
    ];
});
...
_s4(useFirestore, "Ji0v3CVyR05GsJImBIA8jBWheXQ=", false, function() {
    return [
        useFirebaseContext
    ];
});
...
//# sourceMappingURL=src_f0835b7e._.js.map