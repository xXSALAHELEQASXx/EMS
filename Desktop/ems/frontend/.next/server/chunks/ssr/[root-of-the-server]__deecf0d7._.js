...
const leaveAPI = {
    ...
    approve: (id, status, rejectionReason)=>api.patch(`/leave/${id}`, {
            status,
            rejectionReason
        }),
...
const attendanceAPI = {
    ...
    createRecord: (data)=>api.post('/attendance/record', data)
};
const payrollAPI = {
    getAll: (params)=>api.get('/payroll', {
            params
        }),
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (storedToken && storedUser) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authAPI"].getProfile().then((response)=>{
    ...
    const login = async (email, password)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authAPI"].login({
                email,
                password
            });
    ...
    const register = async (userData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authAPI"].register(userData);
            const data = response.data;
            if (data.success) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__deecf0d7._.js.map