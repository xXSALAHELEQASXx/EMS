        ...
        try {
            ...
            for (const a of attendance){
                try {
                    ...
                    console.log('Checking attendance:', {
                        ...
                        empId,
                        userId,
                        match: attDate === today && String(empId) === String(userId)
                    });
                    if (attDate === today && String(empId) === String(userId)) {
                        todayAttendance = a;
            ...
            if ([
                ...
                const myPayroll = payrolls.find((p)=>{
                    ...
                    return String(pEmpId) === String(userId);
                });
...
//# sourceMappingURL=_a0081645._.js.map